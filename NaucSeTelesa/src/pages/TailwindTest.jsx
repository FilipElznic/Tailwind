...
function TailwindTest() {
  return (
    <>
      <div className="lg:flex lg:items-center lg:justify-between bg-slate-800">
        ...
        <div className="mt-5 flex lg:ml-4 lg:mt-0">
          ...
          <div className="relative ml-3 sm:hidden">
            ...
            <div
              className="absolute right-0 z-10 -mr-1 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none"
              role="menu"
